                ...
                <div className="border-b border-emerald-500/20 bg-emerald-500/10 p-4 flex items-center gap-3">
                    ...
                    <div>
                        <p className="text-sm text-emerald-800 font-medium">
                            {t('submittedTitle')} <strong className="font-bold text-emerald-900">{mySessionDetail.playerName}</strong>.
                        </p>
                            ...
                            {entries.map((entry, index) => {
                                ...
                                return (
                                    <tr
                                        ...
                                        className={`hover:bg-muted/50 transition-colors ${isMe ? 'bg-primary/5' : ''}`}
                                    >
                                        <td className="p-4">
