...
export const OBJECTS: SmritiObject[] = [
  { id: 'gamosa', name: { en: 'Gamosa', as: 'গামোচা', hi: 'गमछा', bn: 'গামছা', ne: 'गमछा', brx: 'गामोसा', mni: 'গামোসা' }, emoji: '🧣', category: 'textile', categoryColor: '#8B6914' },
  { id: 'jaapi', name: { en: 'Jaapi', as: 'জাপি', hi: 'जापी', bn: 'জাপি', ne: 'जापी', brx: 'जापि', mni: 'জাপি' }, emoji: '👒', category: 'craft', categoryColor: '#5C4510' },
  ...
  { id: 'mekhela', name: { en: 'Mekhela', as: 'মেখেলা', hi: 'मेखेला', bn: 'মেখেলা', ne: 'मेखेला', brx: 'मेखेला', mni: 'মেখেলা' }, emoji: '👘', category: 'textile', categoryColor: '#8B6914' },
  ...
  { id: 'tamul', name: { en: 'Betel Nut', as: 'তামোল', hi: 'सुपारी', bn: 'তামুল (সুপারি)', ne: 'सुपारी', brx: 'ताम्बुल', mni: 'গুয়া' }, emoji: '🌿', category: 'food', categoryColor: '#C62828' },
  ...
  { id: 'tea_leaf', name: { en: 'Tea Leaf', as: 'চাহ পাত', hi: 'चाय पत्ती', bn: 'চা পাতা', ne: 'चियापत्ती', brx: 'चा पाता', mni: 'চা পাতা' }, emoji: '🍵', category: 'food', categoryColor: '#C62828' },
  ...
  { id: 'rice', name: { en: 'Rice', as: 'চাউল', hi: 'चावल', bn: 'চাল', ne: 'चामल', brx: 'मै', mni: 'চাক' }, emoji: '🍚', category: 'food', categoryColor: '#C62828' },
  { id: 'fish', name: { en: 'Fish', as: 'মাছ', hi: 'मछली', bn: 'মাছ', ne: 'माछा', brx: 'ना', mni: 'ঙা' }, emoji: '🐟', category: 'food', categoryColor: '#C62828' },
  { id: 'banana', name: { en: 'Banana', as: 'কল', hi: 'केला', bn: 'কলা', ne: 'केरा', brx: 'केला', mni: 'কেলা' }, emoji: '🍌', category: 'food', categoryColor: '#C62828' },
  { id: 'mango', name: { en: 'Mango', as: 'আম', hi: 'आम', bn: 'আম', ne: 'आँप', brx: 'आम', mni: 'আম' }, emoji: '🥭', category: 'food', categoryColor: '#C62828' },
  ...
  { id: 'kaji_nemu', name: { en: 'Assam Lemon', as: 'কাজী নেমু', hi: 'कागजी नींबू', bn: 'আসামের লেবু', ne: 'असमिया कागती', brx: 'असम लेबु', mni: 'আসাম লেবু' }, emoji: '🍋', category: 'food', categoryColor: '#C62828' },
  { id: 'jackfruit', name: { en: 'Jackfruit', as: 'কঠাল', hi: 'कटहल', bn: 'কাঁঠাল', ne: 'कटहर', brx: 'कटहल', mni: 'কাঁঠাল' }, emoji: '🍈', category: 'food', categoryColor: '#C62828' },
  { id: 'betel_leaf', name: { en: 'Betel Leaf', as: 'পান', hi: 'पान', bn: 'পান', ne: 'पान', brx: 'पान', mni: 'পান' }, emoji: '🍃', category: 'food', categoryColor: '#C62828' },
  { id: 'curd', name: { en: 'Curd', as: 'দৈ', hi: 'दही', bn: 'দই', ne: 'दही', brx: 'दही', mni: 'দই' }, emoji: '🥛', category: 'food', categoryColor: '#C62828' },
  { id: 'king_chili', name: { en: 'King Chili', as: 'ভূত জলকীয়া', hi: 'भूत जोलोकिया', bn: 'ভূত জলকিয়া', ne: 'भूत जोलोकिया', brx: 'भूत जोलोकिया', mni: 'ভূত জলকিয়া' }, emoji: '🌶️', category: 'food', categoryColor: '#C62828' },
  { id: 'ginger', name: { en: 'Ginger', as: 'আদা', hi: 'अदरक', bn: 'আদা', ne: 'अदुवा', brx: 'आदा', mni: 'আদা' }, emoji: '🫚', category: 'food', categoryColor: '#C62828' },
  ...
  { id: 'orange', name: { en: 'Orange', as: 'কমলা', hi: 'संतरा', bn: 'কমলা', ne: 'सुन्तला', brx: 'कमला', mni: 'কমলা' }, emoji: '🍊', category: 'food', categoryColor: '#C62828' },
  { id: 'pineapple', name: { en: 'Pineapple', as: 'আনাৰস', hi: 'अनानास', bn: 'আনারস', ne: 'भुइँकटहर', brx: 'अनानास', mni: 'আনারস' }, emoji: '🍍', category: 'food', categoryColor: '#C62828' },
  ...
  { id: 'eri_silk', name: { en: 'Eri Silk', as: 'এৰি পাট', hi: 'एरी सिल्क', bn: 'এরি রেশম', ne: 'एरी रेशम', brx: 'एरि रेशम', mni: 'এরি রেশম' }, emoji: '🧶', category: 'textile', categoryColor: '#8B6914' },
  { id: 'sador', name: { en: 'Sador', as: 'চাদৰ', hi: 'चादर', bn: 'চাদর', ne: 'चादर', brx: 'चादर', mni: 'চাদর' }, emoji: '🥻', category: 'textile', categoryColor: '#8B6914' },
  { id: 'handloom', name: { en: 'Handloom', as: 'তাঁত', hi: 'हथकरघा', bn: 'তাঁত', ne: 'हातले बुन्ने तान', brx: 'ताँत', mni: 'তাঁত' }, emoji: '🧵', category: 'textile', categoryColor: '#8B6914' },
