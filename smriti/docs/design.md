...
**Status:** Reference-driven design specification**Author:** Manus AI**Reference:** [1]**Purpose:** Provide a practical visual and interaction system for a healthcare technology website that feels trustworthy, editorial, calm, and operationally rigorous without reproducing the source site verbatim.
